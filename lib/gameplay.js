    ...
    addNote(key) {
        switch(key) {
            case "q":
                ...
                break;
            case "w":
                this.notes.push(new Note({pos: [160,800], val: "q"}));
                break;
            case "e":
                this.notes.push(new Note({pos: [270,800], val: "q"}));
                break;
            case "r":
                this.notes.push(new Note({pos: [380,800], val: "q"}));
                break;
            case "t":
                this.notes.push(new Note({pos: [490,800], val: "q"}));
                break;
        }
    }
